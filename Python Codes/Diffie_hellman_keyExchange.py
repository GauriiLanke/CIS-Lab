...
def is_primitive_root(alpha, q):
    required_set = set(num for num in range(1, q-1)) #required set of numbers from 1 to q-1
    actual_set = set(pow(alpha, powers, q) for powers in range(1, q-1)) #actual set of numbers generated by alpha
